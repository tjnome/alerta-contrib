...
class GraylistAlertTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        response = self.client.post('/filter', data=json.dumps(filter_data), headers={'Content-type': 'application/json'})
    ...
    def test_bypass_graylist_for_alert(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Production",
        ...
        self.assertEqual(json_resp['alert']['environment'], data['environment'])
        self.assertEqual(json_resp['alert']['service'], data['service'])
        self.assertEqual(json_resp['alert']['group'], data['group'])
        self.assertEqual(len(json_resp['alert']['tags']), 1)
    ...
    def test_alert_add_host(self):
        ...
        self.assertTrue('customerprefix=test.customerprefix' in json_resp['alert']['tags'])
        self.assertTrue('externalid=test.externalid' in json_resp['alert']['tags'])

    def test_alert_add_incorrect_host(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Production",
    ...
    def test_alert_add_customer(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Production",
    ...
    def test_alert_targethost_self(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Production",
    ...
    def test_alert_targethost_notself(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Production",
    ...
    def test_alert_targethost_notself_customer(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Production",
    ...
    def test_alert_targethost_notself_graylisted(self):
        data = {
            "resource": "resource",
            "event": "event",
            "environment": "Development",
        ...
        self.assertTrue('customerprefix=test.customerprefix.notself' in json_resp['alert']['tags'])
        self.assertTrue('externalid=test.externalid.notself' in json_resp['alert']['tags'])